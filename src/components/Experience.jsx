    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        {experienceData.map((experience, index) => (
          <div
            key={index}
            className="relative grid grid-cols-1 md:grid-cols-2 gap-8 px-8 py-4 md:py-10"
          >
            ...
            text-text
            text-sm font-bold`,
                  experience.isCurrent && "bg-primary",
                )}
              >
                {experience.period}
              </span>
            ...
            <div className="absolute top-18 left-2 md:left-1/2 md:-translate-x-1/2 h-full">
              <div
                className={cn(
                  "w-4 h-4 rounded-full bg-border border-4 border-bg mx-auto",
                  experience.isCurrent && "bg-primary",
                )}
              />
              {index < experienceData.length - 1 && (
                <div
                  className={cn(
                    "w-px absolute top-4 bottom-4 left-1/2 -translate-x-1/2 bg-border mx-auto",
                    experience.isCurrent && "bg-primary/50",
                  )}
                />
              )}
            </div>
            ...
            >
              <h3
                className={cn(
                  ...
                  experience.isCurrent && "text-primary",
                )}
              >
                {experience.role}
              </h3>
              ...
              <ul className="mt-4 ml-4 list-disc space-y-2 text-text-muted leading-relaxed md:text-justify">
